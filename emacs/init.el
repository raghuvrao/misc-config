...
(custom-set-faces
 ...
 '(mode-line ((((type tty) (class color) (min-colors 16)) (:background "blue" :foreground "brightwhite" :weight bold)) (((type tty) (class color) (min-colors 8)) (:background "blue" :foreground "white" :weight bold))))
 '(mode-line-inactive ((((type tty) (class color) (min-colors 16)) (:background "magenta" :foreground "brightwhite" :weight bold)) (((type tty) (class color) (min-colors 8)) (:background "magenta" :foreground "white" :weight bold))))
 '(org-block ((t nil)))
 '(org-date ((t nil)))
 '(org-meta-line ((t nil)))
 '(org-table ((t nil)))
