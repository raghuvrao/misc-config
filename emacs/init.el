...
(custom-set-faces
 ...
 '(mode-line ((((type tty) (class color) (min-colors 16) (background light)) (:background "blue" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background light)) (:background "blue" :foreground "white" :weight bold))))
 '(mode-line-buffer-id ((((type tty) (background light)) nil)))
 '(mode-line-inactive ((((type tty) (class color) (min-colors 8) (background light)) (:background "cyan" :foreground "black"))))
 '(org-block ((t nil)))
 '(org-date ((t nil)))
 '(org-meta-line ((t nil)))
 '(org-table ((t nil)))
