...
(custom-set-faces
 ...
 '(mode-line ((((type tty) (class color) (min-colors 16) (background light)) (:background "magenta" :foreground "brightwhite" :weight bold)) (((type tty) (class color) (min-colors 8) (background light)) (:background "magenta" :foreground "white" :weight bold))))
 '(mode-line-buffer-id ((((type tty) (background light)) nil)))
 '(mode-line-inactive ((((type tty) (class color) (min-colors 16) (background light)) (:background "blue" :foreground "brightwhite" :weight bold)) (((type tty) (class color) (min-colors 8) (background light)) (:background "blue" :foreground "white" :weight bold))))
 '(org-block ((t nil)))
 '(org-date ((t nil)))
 '(org-meta-line ((t nil)))
 '(org-table ((t nil)))
 ...
 '(vertical-border ((((type tty) (class color) (min-colors 8) (background light)) (:background "white" :foreground "magenta"))))
