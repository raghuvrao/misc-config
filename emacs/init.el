...
(custom-set-faces
 ...
 '(custom-button-pressed ((((type x ns) (class color) (background dark)) (:background "#737373" :foreground "#000000" :box (:line-width 1 :style pressed-button)))))
 '(diff-added ((((type x ns) (class color) (background dark)) (:foreground "#30bf30")) (((type tty) (class color) (min-colors 8) (background dark)) (:foreground "green"))))
 '(diff-context ((((type x ns) (class color grayscale) (background dark)) (:foreground "#bfbfbf")) (((type tty) (class color grayscale) (min-colors 8) (background dark)) (:foreground "white"))))
 '(diff-file-header ((((type x ns) (class color) (background dark)) (:foreground "#40ffff" :weight bold)) (((type tty) (class color) (min-colors 16) (background dark)) (:foreground "brightcyan" :weight bold)) (((type tty) (class color) (min-colors 8) (background dark)) (:foreground "cyan" :weight bold))))
 '(diff-header ((((type x ns) (class color) (background dark)) (:foreground "#30bfbf")) (((type tty) (class color) (min-colors 8) (background dark)) (:foreground "cyan"))))
 '(diff-refine-added ((((type x ns) (class color) (background dark)) (:foreground "#40ff40" :weight bold)) (((type tty) (class color) (min-colors 16) (background dark)) (:foreground "brightgreen" :weight bold)) (((type tty) (class color) (min-colors 8) (background dark)) (:background "green" :foreground "black"))))
 '(diff-refine-removed ((((type x ns) (class color) (background dark)) (:foreground "#ff4040" :weight bold)) (((type tty) (class color) (min-colors 16) (background dark)) (:foreground "brightred" :weight bold)) (((type tty) (class color) (min-colors 8) (background dark)) (:background "red" :foreground "white"))))
 '(diff-removed ((((type x ns) (class color) (background dark)) (:foreground "#bf3030")) (((type tty) (class color) (background dark)) (:foreground "red"))))
 '(error ((((type tty) (class color) (min-colors 16) (background dark)) (:background "red" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background dark)) (:background "red" :foreground "white" :weight bold)) (((type x ns) (class color) (background dark)) (:background "#bf3030" :foreground "#ffffff"))))
 '(font-lock-builtin-face ((t (:underline t))))
 '(font-lock-comment-face ((((type x ns) (class color) (background dark)) (:foreground "#30bfbf")) (((type tty) (class color) (background dark)) (:foreground "cyan"))))
 '(font-lock-constant-face ((t nil)))
 '(font-lock-doc-face ((((type x ns) (class color) (background dark)) (:foreground "#30bf30")) (((type tty) (class color) (background dark)) (:foreground "green"))))
 ...
 '(font-lock-warning-face ((((type tty) (class color) (min-colors 16) (background dark)) (:foreground "brightred")) (((type tty) (class color) (min-colors 8) (background dark)) (:foreground "red")) (((type x ns) (class color) (background dark)) (:foreground "#bf7830"))))
 '(fringe ((((type x ns) (class color) (background dark)) (:background "#333333" :foreground "#407fff"))))
 '(header-line ((((type tty) (background dark)) (:weight bold))))
 '(highlight ((((type x ns) (class color) (background dark)) (:background "#004000" :foreground "#40ff40"))))
 '(hl-line ((((type x ns) (class color) (background dark)) (:background "#004000")) (((type tty) (class color) (min-colors 256) (background dark)) (:background "color-237")) (((type tty) (background dark)) (:underline t))))
 '(isearch ((((type x ns) (class color) (background dark)) (:background "#ff40ff" :foreground "#000000")) (((type tty) (class color) (min-colors 16) (background dark)) (:background "brightmagenta" :foreground "black")) (((type tty) (class color) (min-colors 8) (background dark)) (:background "magenta" :foreground "white" :weight bold))))
 '(lazy-highlight ((((type x ns) (class color) (background dark)) (:background "#30bfbf" :foreground "#000000")) (((type tty) (class color) (min-colors 8) (background dark)) (:background "cyan" :foreground "black"))))
 ...
 '(org-verbatim ((t nil)))
 '(outline-4 ((t nil)))
 '(region ((((type x ns) (class color) (background dark)) (:background "#bf7830" :foreground "#000000")) (((type tty) (class color) (min-colors 8) (background dark)) (:background "yellow" :foreground "black"))))
 '(sh-quoted-exec ((t nil)))
 '(shadow ((((type x ns) (class color) (background dark)) (:foreground "#885500"))))
 '(show-paren-match ((((type x ns) (class color) (background dark)) (:background "#3030bf" :foreground "#ffffff" :weight bold :underline t)) (((type tty) (class color) (background dark)) (:background "blue" :foreground "brightwhite" :weight bold :underline t))))
 '(show-paren-mismatch ((((type x ns) (class color) (background dark)) (:background "#bf3030" :foreground "#ffffff" :weight bold)) (((type tty) (class color) (background dark)) (:background "red" :foreground "brightwhite" :weight bold))))
 ...
 '(tab-line ((((type x ns) (class color) (background dark)) (:background "#bfbfbf" :foreground "#000000")) (((type tty) (class color) (min-colors 8) (background dark)) (:background "white" :foreground "black"))))
 '(tab-line-highlight ((((type x ns) (class color) (background dark)) (:background "#ffffff" :foreground "#000000"))))
 '(tab-line-tab ((((type x ns) (class color) (background dark)) (:background "#737373" :foreground "#bfbfbf" :box (:line-width 1 :color "#737373"))) (((type tty) (class color) (min-colors 16) (background dark)) (:background "brightblack" :foreground "white")) (((type tty) (class color) (min-colors 8) (background dark)) (:background "yellow" :foreground "black"))))
 '(tab-line-tab-current ((((type x ns) (class color) (background dark)) (:background "#30bfbf" :foreground "#000000" :box (:line-width 1 :color "#004040"))) (((type tty) (class color) (min-colors 8) (background dark)) (:background "cyan" :foreground "black"))))
 '(tab-line-tab-inactive ((((type x ns) (class color) (background dark)) (:background "#bfbfbf" :foreground "#000000" :box (:line-width 1 :color "#737373"))) (((type tty) (class color) (min-colors 8) (background dark)) (:background "white" :foreground "black"))))
 '(trailing-whitespace ((((type x ns) (class color) (background dark)) (:background "#bf3030")) (((type tty) (class color) (background dark)) (:background "red"))))
 ...
 '(widget-field ((((type x ns) (class color) (background dark)) (:background "#737373" :foreground "#ffffff" :box (:line-width 1 :color "#737373" :style pressed-button))) (((type tty) (background dark)) (:inverse-video t))))
