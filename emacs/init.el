...
(custom-set-faces
 ...
 '(font-lock-comment-face ((((type x) (class color) (background light)) (:foreground "brown")) (((type tty) (class color) (min-colors 256) (background light)) (:foreground "color-130")) (((type tty) (class color) (min-colors 8) (background light)) (:foreground "yellow"))))
 ...
 '(header-line ((((type tty) (class color) (background light)) (:background "grey85" :foreground "black" :underline t)) (((type tty) (class color) (background dark)) (:background "black" :foreground "grey85" :underline t))))
 '(hl-line ((((type x) (class color)) (:inherit fringe)) (((type tty) (class color) (min-colors 256) (background light)) (:background "color-254")) (((type tty) (class color) (min-colors 16) (background light)) (:background "brightyellow")) (((type tty) (class color) (min-colors 8) (background light)) (:background "green" :foreground "black"))))
 '(isearch ((((type x) (class color) (background light)) (:background "plum2" :foreground "black")) (((type tty) (class color) (min-colors 256) (background light)) (:background "color-219" :foreground "black")) (((type tty) (class color) (min-colors 16) (background light)) (:background "magenta" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background light)) (:background "magenta" :foreground "white" :weight bold))))
 '(isearch-fail ((((type tty) (class color) (min-colors 16) (background light)) (:background "red" :foreground "brightwhite" :weight bold)) (((type tty) (class color) (min-colors 8) (background light)) (:background "red" :foreground "white" :weight bold))))
 '(lazy-highlight ((((type x) (class color) (background light)) (:background "LightSkyBlue1" :foreground "black")) (((type tty) (class color) (min-colors 256) (background light)) (:background "color-153" :foreground "black")) (((type tty) (class color) (min-colors 16) (background light)) (:background "brightcyan" :foreground "black")) (((type tty) (class color) (min-colors 8) (background light)) (:background "cyan" :foreground "black"))))
 '(mode-line ((((type tty) (class color) (min-colors 256) (background light)) (:background "magenta" :foreground "color-254")) (((type tty) (class color) (min-colors 16) (background light)) (:background "magenta" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background light)) (:background "magenta" :foreground "white" :weight bold))))
 '(mode-line-inactive ((((type tty) (class color) (min-colors 256) (background light)) (:background "blue" :foreground "color-251")) (((type tty) (class color) (min-colors 16) (background light)) (:background "blue" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background light)) (:background "blue" :foreground "white" :weight bold))))
 '(org-block ((t nil)))
 '(org-date ((t nil)))
 '(org-meta-line ((t nil)))
 '(org-table ((t nil)))
 '(org-verbatim ((t nil)))
 '(outline-4 ((t nil)))
 '(region ((((type x) (class color) (background light)) (:background "LightGoldenrod2" :foreground "black")) (((type tty) (class color) (min-colors 256) (background light)) (:background "color-221" :foreground "black")) (((type tty) (class color) (min-colors 16) (background light)) (:background "blue" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background light)) (:background "blue" :foreground "white"))))
 '(sh-quoted-exec ((t nil)))
 '(show-paren-match ((((type tty) (class color) (min-colors 16) (background light)) (:background "brightcyan"))))
 '(show-paren-mismatch ((((type tty) (class color) (min-colors 256) (background light)) (:background "color-224" :foreground "color-88")) (((type tty) (class color) (min-colors 16) (background light)) (:background "red" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background light)) (:background "red" :foreground "white" :weight bold))))
 '(trailing-whitespace ((((type x) (class color) (background light)) (:background "aquamarine2")) (((type tty) (class color) (min-colors 256) (background light)) (:background "color-122")) (((type tty) (class color) (min-colors 16) (background light)) (:background "brightcyan")) (((type tty) (class color) (min-colors 8) (background light)) (:background "cyan"))))
