...
(custom-set-faces
 ...
 '(mode-line ((((type x) (class color) (background light)) (:background "grey82" :foreground "black" :box (:line-width (1 . 1) :color "black")))))
 '(mode-line-highlight ((((type x) (class color) (background light)) (:background "PaleTurquoise"))))
 '(mode-line-inactive ((((type x) (class color) (background light)) (:inherit mode-line :background "gray92" :box (:line-width (1 . 1) :color "grey60")))))
 '(org-block ((t nil)))
 '(org-checkbox ((t nil)))
 '(org-date ((t nil)))
 ...
 '(tty-menu-disabled-face ((((type tty) (class color) (min-colors 88)) (:background "blue" :foreground "grey"))))
