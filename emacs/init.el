...
(custom-set-faces
 ...
 '(hl-line ((((type x) (class color)) (:inherit fringe)) (((type tty) (class color) (min-colors 256) (background light)) (:background "color-254")) (((type tty) (class color) (min-colors 16) (background light)) (:background "brightyellow")) (((type tty)) (:inverse-video t))))
 ...
 '(mode-line ((((type tty) (class color) (min-colors 16) (background light)) (:background "blue" :foreground "brightwhite" :weight bold)) (((type tty) (class color) (min-colors 8) (background light)) (:background "blue" :foreground "white" :weight bold))))
 '(mode-line-inactive ((((type tty) (class color) (min-colors 16) (background light)) (:background "magenta" :foreground "brightwhite" :weight bold)) (((type tty) (class color) (min-colors 8) (background light)) (:background "magenta" :foreground "white" :weight bold))))
 '(org-block ((t nil)))
 '(org-date ((t nil)))
 '(org-meta-line ((t nil)))
 '(org-table ((t nil)))
 '(org-verbatim ((t nil)))
 '(outline-4 ((t nil)))
 '(region ((((type x) (class color) (background light)) (:background "LightSkyBlue1" :foreground "black")) (((type tty) (class color) (background light) (min-colors 256)) (:background "color-153" :foreground "black")) (((type tty) (class color) (min-colors 8) (background light)) (:background "blue" :foreground "white" :weight bold))))
