...
(custom-set-faces
 ...
 '(mode-line ((((type tty) (class color) (min-colors 256) (background light)) (:background "color-89" :foreground "brightwhite")) (((type tty) (class color) (min-colors 16) (background light)) (:background "magenta" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background light)) (:background "magenta" :foreground "white" :weight bold))))
 '(mode-line-inactive ((((type tty) (class color) (min-colors 256) (background light)) (:background "color-17" :foreground "brightwhite")) (((type tty) (class color) (min-colors 16) (background light)) (:background "blue" :foreground "brightwhite")) (((type tty) (class color) (min-colors 8) (background light)) (:background "blue" :foreground "white" :weight bold))))
 '(org-block ((t nil)))
 '(org-date ((t nil)))
 '(org-meta-line ((t nil)))
 '(org-table ((t nil)))
